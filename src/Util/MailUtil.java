...
public class MailUtil {
    ...
    public static void main(String[] args) {
        ...
        mail.setSender("18768349255@163.com");
        mail.setReceiver("715686280@qq.com"); // 接收人
        mail.setUsername("18768349255@163.com"); // 登录账号,一般都是和邮箱名一样吧
        mail.setPassword("qq715686280"); // 发件人邮箱的登录密码
